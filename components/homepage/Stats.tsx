...
function Stats({}: Props) {
  return (
    <div className="mx-auto mt-28 flex w-full flex-col  items-center justify-center gap-5  max-md:max-w-full max-md:flex-wrap md:mt-28 lg:flex-row">
      ...
      <div className="my-auto hidden h-10 w-0.5 shrink-0 flex-col self-stretch border-2 border-solid border-white border-opacity-60 bg-white bg-opacity-60 md:flex lg:flex-row" />
      <hr className="w-48 border md:hidden " />
      ...
      <div className="my-auto hidden h-10 w-0.5 shrink-0 self-stretch border-2 border-solid border-white border-opacity-60 bg-white bg-opacity-60 md:flex" />
      <hr className="w-48 border md:hidden " />
