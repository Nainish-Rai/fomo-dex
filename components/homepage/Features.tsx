...
function Features({}: Props) {
  return (
    <div className="mx-auto w-full max-w-7xl">
      {' '}
      <div className="mt-44 text-center text-6xl font-extrabold leading-[100px] text-white max-md:mt-10 max-md:max-w-full max-md:text-4xl max-md:leading-[74px]">
        Features of <span className="text-lime-400">FOMO</span>
      </div>
      <div className="mt-16 text-xl leading-7 text-white max-md:mt-10 max-md:max-w-full md:text-center">
      ...
      <div className="mt-20 w-full max-w-[1430px] px-0.5 max-md:mt-10 max-md:max-w-full">
        ...
        <div className="flex flex-row-reverse items-center gap-5 max-md:flex-col-reverse max-md:gap-0">
          <div className="flex w-[55%] flex-col max-md:ml-0 max-md:w-full">
            <FeatureCard
              title={'Referral Mechanism'}
              paragraph={
